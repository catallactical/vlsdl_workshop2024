 ...
 * @version 1.0
 *
 * @brief A time watcher can be used to perform and report time measurements.
 */
class TimeWatcher {
protected:
    // ***  ATTRIBUTES  *** //
...
public:
    ...
    void reportSeconds(
        ostream &os,
        string msg = "Total elapsed seconds: "
    );
    /**
    ...
    void reportMillis(
        ostream &os,
        string msg = "Total elapsed milliseconds: "
    );
    /**
     ...
     *  "Total elapsed time: "
     */
    void reportFormat(ostream &os, string msg="Total elapsed time: ");

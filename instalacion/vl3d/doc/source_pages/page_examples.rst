...
`contact@catallactical.com <contact@catallactical.com>`_,
...
.. toctree::
    ...
    KPConv-like model for point-wise classification in the Hessigheim March2018 dataset <examples/example_hessig_kpconv>
